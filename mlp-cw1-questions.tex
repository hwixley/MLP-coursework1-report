...
\youranswer{
Yes Dropout is compatible with Maxout as the founding paper on Maxout networks \cite{goodfellow2013maxout} used Maxout in conjunction with Dropout to test on benchmark datasets. This is evident given Maxout was developed as a method to enhance dropout's abilities as a model averaging technique
}
}
...
\begin{figure*}[t]
    ...
    \begin{subfigure}{.3\linewidth}
        \centering
        \includegraphics[width=1\linewidth]{figures/combined-val-acc-gen-gap-bar.pdf}
