...
dropout is a very effective technique for mitigating overfitting as it has the effect of making the training process noisy, and ultimately forcing nodes within a layer to probabilistically take on more or less responsibility for the inputs.s, for all combinations of hidden units and layers dropout always improved performance.} 
}
