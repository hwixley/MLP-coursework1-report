...
\youranswer{
Yes Dropout is compatible with Maxout as the founding paper on Maxout networks \cite{goodfellow2013maxout} used Maxout in conjunction with Dropout to test on benchmark datasets
}
}
