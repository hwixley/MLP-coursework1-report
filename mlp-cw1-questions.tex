...
The first step I would take towards optimising my models would be through optimising the number of epochs used. Throughout all our experiments we set the number of epochs to be constant at 100. This is 
...
To optimise this Dropout model even further we could optimise the number of Dropout layers used, their placement within the network (before which Affine layers), and the Dropout probabilities used for each of these layers.
