...
And now we can try to reach the \emph{new} local/global minimum of our error function by using the following equation:
...
This added regularisation term evidently 
