...
\youranswer{
maxout networks have beneficial characteristics for both optimization and model averaging with dropout.
...
$$\text{where } z_{ij}=x^T W_{...ij} + b_{ij} \text{, and } W \in \mathbb{R}^{d \times m \times k}$$
}
}
