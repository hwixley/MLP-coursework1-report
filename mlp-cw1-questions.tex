...
FUTURE
To optimise this Dropout model even further in the future we could optimise the number of Dropout layers used, their placement within the network (before which Affine layers), and the Dropout probabilities used for each of these layers.

To optimise the L1 and L2 regularization models even further 
}
}
